...
insert  into `t_channel`(`cid`,`cname`,`calias`,`pid`,`cnamepath`,`cidpath`,`creattime`,`tsequence`,`lid`) values (1,'首页','首页',0,'/首页','/1','2019-03-14 16:22:07',1,1),(2,'公司业务','公司业务',0,'/公司业务','/2','2019-03-11 16:27:05',2,1),(3,'个人业务','个人业务',0,'/个人业务','/3','2019-03-05 16:27:24',3,1),(4,'互联网金融','互联网金融',0,'/互联网金融','/4','2019-03-04 16:27:30',4,1),(5,'国际业务','国际业务',0,'/国际业务','/5','2019-03-11 16:27:34',5,1),(6,'重要通知','重要通知',1,'/首页/重要通知','/1/6','2019-03-05 16:53:45',6,1),(7,'热点推荐','热点推荐',1,'/首页/热点推荐','/1/7','2019-03-06 16:55:09',7,1),(8,'常用信息','常用信息',1,'/首页/常用信息','/1/8','2019-03-05 16:55:04',8,1),(9,'用户登录区','用户登录区',1,'/首页/用户登录区','/1/9','2019-03-06 16:54:48',9,1);

/*Table structure for table `t_channel_article` */
...
/*Data for the table `t_channel_article` */

insert  into `t_channel_article`(`cid`,`aid`) values (1,1),(2,2),(3,3),(4,4);
